...
class Email
{
    ...
    public function __construct($smtpDebug, $host, $user, $pass, $smtpSecure, $port, $setFromEmail, $setFromName)
    {
        ...
        $this->mail->CharSet    = 'utf-8';                        // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
        $this->mail->setLanguage('br');                           // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
